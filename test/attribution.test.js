...
const ENV_KEYS = ["STRIPE_SECRET_KEY", "STRIPE_LIVE_SECRET_KEY", "STRIPE_RESTRICTED_KEY", "STRIPE_MODE", "DELIVERY_PUBLIC_ORIGIN", "CHECKOUT_ALLOWED_ORIGINS", "CHECKOUT_ALLOW_NO_ORIGIN"];
const savedEnv = {};
